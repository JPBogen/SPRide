...
const ctx = document.getElementById("Sensorgram") as HTMLCanvasElement;

//Defines CanvasContainer as a Div element and the items which size the container should encompass
var CanvasContainer = document.getElementById("canvas-container")  as HTMLDivElement;

//List of the item 1-7. Their height is the heigt of the sensorgram
const ItemListForCanvasContainer: HTMLDivElement[] = [
...
function Generate_Graph(datavalues : AffinitySimulation.XYValue[], xAxixTitel: string, PointColor : string) : void
 {
