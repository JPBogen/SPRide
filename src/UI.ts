...
var mode : BindingMode = BindingMode.MCK;

// #region kinetic parameters and variables

var AssociationTime : number; // in s
var DissociationTime : number; //in s
var DissociationInBetweenTime : number; //in s

var kon : number; // in Ms
var kdis : number ; // in 1/s

var NumberOfCyles : number;
var DilutionFactor : number;

var MaximalConcentration : number; // in M

var DissociationInSCK : boolean;

var KD : number; // in M
var Halflife : number; // in sec
...
//Input field
var CycleInput = document.getElementById("CycleInput") as HTMLInputElement;
var DilutionInput = document.getElementById("DilutionInput") as HTMLInputElement;
var ConcInput = document.getElementById("ConcInput") as HTMLInputElement;
var konInput = document.getElementById("konInput") as HTMLInputElement;
var kdisInput = document.getElementById("kdisInput") as HTMLInputElement;
var AssociationTimeInput = document.getElementById("AssociationTimeInput") as HTMLInputElement;
var DissociationTimeInput = document.getElementById("DissociationTimeInput") as HTMLInputElement;
var KDInput = document.getElementById("KDInput") as HTMLInputElement;
var DissociationInBetweenTimeInput = document.getElementById("DissociationInBetweenTimeInput") as HTMLInputElement;

DissociationInBetweenTimeInput.disabled = true;

//Dropdown fields
var ConcDimensionDD = document.getElementById("ConcDimensionDD") as HTMLSelectElement;
var BindingModeDD = document.getElementById("BindingModeDD") as HTMLSelectElement;
var konDimensionDD = document.getElementById("konDimensionDD") as HTMLSelectElement;
var kdisDimensionDD = document.getElementById("kdisDimensionDD") as HTMLSelectElement;

var KDDD = document.getElementById("KDDD") as HTMLSelectElement;
var HalflifeDD = document.getElementById("HalflifeDD") as HTMLSelectElement;
var ThetaDD = document.getElementById("ThetaDD") as HTMLSelectElement;


//Checkboxes
var DissInBetweenCheck = document.getElementById("DissInBetweenCheck") as HTMLInputElement;
var SteadyStateSwitch = document.getElementById("SteadyStateSwitch") as HTMLInputElement;

//Labels
var HalflifeLabel = document.getElementById("HalflifeLabel") as HTMLLabelElement;
var ThetaLabel = document.getElementById("ThetaLabel") as HTMLLabelElement;
var FreeEnergyLabel = document.getElementById("FreeEnergyLabel") as HTMLLabelElement;
var ThetaeqLabel = document.getElementById("ThetaeqLabel") as HTMLLabelElement;
...
function attachPlotValuesListener(element: HTMLInputElement | HTMLSelectElement) {
...
function ActivateMode(mode : BindingMode) : void
{
...
function Parse_kon() : void
{
    var dimension : number = 0;

    switch (konDimensionDD.value)
    {
        case "10E1" : dimension = 10; break;
        case "10E2" : dimension = 100; break;
        case "10E3" : dimension = 1000; break;
        case "10E4" : dimension = 10000; break;
        case "10E5" : dimension = 100000; break;
        case "10E6" : dimension = 1000000; break;
    }
...
function Parse_kdis() : void
{
    var dimension : number = 0;

    switch (kdisDimensionDD.value)
    {
        case "10E-1" : dimension = 10 ** -1; break;
        case "10E-2" : dimension = 10 ** -2; break;
        case "10E-3" : dimension = 10 ** -3; break;
        case "10E-4" : dimension = 10 ** -4; break;
        case "10E-5" : dimension = 10 ** -5; break;
        case "10E-6" : dimension = 10 ** -6; break;
    }
...
function Parse_Conc() : void
{
    var dimension : number = 0;

    switch (ConcDimensionDD.value)
    {
        case "M" : dimension = 1; break;
        case "mM" : dimension = 10 ** -3; break;
        case "µM" : dimension = 10 ** -6 ; break;
        case "nM" : dimension = 10 ** -9; break;
        case "pM" : dimension = 10 ** -12; break;
        case "fM" : dimension = 10 ** -15; break;
    }
...
function CheckValue(input : string, minimum : number, inputelement : HTMLInputElement, maximum? : number) : number
{
    ...
    if(maximum != undefined && interim > maximum)
    {
...
function Plot_Values() :void
{
    ParseUserInput();

    FillLabels();

    var Result : AffinitySimulation.XYValue[] = [];
...
function Plot_MCK() : AffinitySimulation.XYValue[]
{
...
function Plot_SCK() : AffinitySimulation.XYValue[]
{
...
function FillLabels() : void
{
    //KD Value calculation
    if (mode != BindingMode.SteadyState)
    {
        var dimensionKD : number = 1;
    
        switch (KDDD.value)
        {
            case "M" : dimensionKD = 1; break;
            case "mM" : dimensionKD = 10 ** -3; break;
            case "µM" : dimensionKD = 10 ** -6 ; break;
            case "nM" : dimensionKD = 10 ** -9; break;
            case "pM" : dimensionKD = 10 ** -12; break;
            case "fM" : dimensionKD = 10 ** -15; break;
        }
        
        var internalKD : string = formatValue(KD, dimensionKD); //Math.round( (KD / dimensionKD) * 100) / 100;
    ...
    var dimensionTime : number = 0;

    switch (HalflifeDD.value)
    {
        case "h" : dimensionTime = 60*60; break;
        case "min" : dimensionTime = 60; break;
        case "s" : dimensionTime = 1; break;
    }

    var internalHalflife : string = formatValue(Halflife, dimensionTime); //Math.round( (Halflife / dimensionTime)*100) / 100;

    HalflifeLabel.textContent = internalHalflife.toString();
    //

    //Theta calculation
    var dimensionThetaTime : number = 0;

    switch (ThetaDD.value)
    {
        case "h" : dimensionThetaTime = 60*60; break;
        case "min" : dimensionThetaTime = 60; break;
        case "s" : dimensionThetaTime = 1; break;
    }

    var internalTheta : string = formatValue(
        AffinitySimulation.Theta(kon, kdis, MaximalConcentration), dimensionThetaTime
    );
...
function formatValue(KD: number, dimensionKD: number): string {
